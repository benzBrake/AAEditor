<script>
    [{
        ...
        insertBefore: '#wmd-bold-button-aaeditor'
    }, {
        id: 'wmd-redo-button-aaeditor',
        ...
        id: 'wmd-strikethrough-button-aaeditor',
        ...
        id: 'wmd-heading-button-aaeditor',
        ...
        insertAfter: '#wmd-quote-button-aaeditor',
    }, {
        id: 'wmd-heading1-button-aaeditor',
        name: '<?php _e("标题1 <h1>"); ?>',
        ...
        id: 'wmd-heading2-button-aaeditor',
        name: '<?php _e("标题2 <h2>"); ?>',
        ...
        id: 'wmd-heading3-button-aaeditor',
        name: '<?php _e("标题3 <h3>"); ?>',
        ...
        id: 'wmd-heading4-button-aaeditor',
        name: '<?php _e("标题4 <h4>"); ?>',
        ...
        id: 'wmd-heading5-button-aaeditor',
        name: '<?php _e("标题5 <h1>"); ?>',
        ...
        id: 'wmd-heading6-button-aaeditor',
        name: '<?php _e("标题1 <h1>"); ?>',
        ...
        id: 'wmd-code-button-aaeditor',
        remove: true
    }, {
        id: 'wmd-inline-code-button-aaeditor',
        name: '<?php _e("行内代码"); ?>',
        ...
        insertAfter: "#wmd-spacer2-aaeditor",
        command() {
            this.openModal({
                title: "<?php _e("插入表格") ?>",
...
<div class="form-item">
    ...
    <input type="checkbox" name="is-center" checked>
        ...
        insertBefore: '#wmd-hr-button-aaeditor',
        command: function () {
            this.blockPrefix("%n. ");
        }
    }, {
        id: 'wmd-ulist-button-aaeditor',
        remove: true,
    }, {
        id: 'wmd-ulist-button-aaeditor',
        name: '<?php _e("无序列表 <ol>"); ?>',
        ...
        id: 'wmd-task-checked-button-aaeditor',
        name: '<?php _e("任务 - 已完成"); ?>',
        ...
        insertAfter: '#wmd-spacer4-aaeditor',
        shortcut: 'ctrl+p',
        command({target}) {
            ...
            $("#wmd-preview-button-aaeditor").attr("active", !previewStatus);
        },
        onMounted(event) {
        ...
        id: 'wmd-code-highlight-button-aaeditor',
        ...
        insertAfter: '#wmd-preview-button-aaeditor',
        onMounted(event) {
            ...
            $(event.target).replaceWith($('<li id="wmd-code-highlight-button-aaeditor" style="padding: 1px;">').append(select));
            $('body').on('XEditorPreviewEnd', () => {
                ...
                let clp = new ClipboardJS('#wmd-preview-aaeditor pre span.copy');
            ...
            function setTheme(filename) {
                ...
                const previewArea = $("#wmd-preview-aaeditor");
        ...
        id: 'wmd-fullscreen-button-aaeditor',
        ...
        id: 'wmd-exit-fullscreen-button-aaeditor',
