...
<div class="form-item">
    ...
    <input type="checkbox" name="is-center" checked>
        ...
        command() {
            this.wrapText('[hide]', '[/hide]', '<?php _e("回复可见"); ?>');
        }
    }, {
    ...
    $('body').trigger('XEditorAddHtmlProcessor', [function (html) {
        ...
        return html.replace(this.getShortCodeRegex("hide"), `<div class="x-hide fake blur">
    ...
    <span class="x-hide-text" onclick="this.parentNode.classList.toggle('blur');">$5</span>
</div>`);
    }]);
